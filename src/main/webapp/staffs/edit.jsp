...
<div class="container">
    <div class="row">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item active">
                            <a class="nav-link color-white" href="http://localhost:8080/staffs?action=edit">Edit Staff <span
        ...
        <div class="col-12 mt-5">
            <form action="http://localhost:8080/staffs?action=edit" method="post">
                <div class="form-row">
